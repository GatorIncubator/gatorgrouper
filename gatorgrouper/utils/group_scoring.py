...
def score_group(student_identifers: Union[List[List[Union[str, bool]]], List[str]]) -> int:
    """ score single group """
    score = 0
...
def score_groups(student_groups: Union[List[List[str]], List[List[List[Union[str, bool]]]]]) -> Tuple[List[int], int]:
